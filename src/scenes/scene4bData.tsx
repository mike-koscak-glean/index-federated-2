...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    persona: {
      ...
      title: 'VP of Sales',
      initials: 'DP',
      context: 'Board meeting in 30 minutes. David needs the latest Q2 pipeline forecast — but the deck has been revised 6 times this week across multiple drafts.',
  ...
  },
  {
    ...
    persona: {
      ...
      initials: 'RT',
      context: 'Trying to close the Apex Corp deal, but a compliance review is stalling it. Rachel needs the legal review notes and the hosting sign-off — fast.',
